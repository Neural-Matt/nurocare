  ...
  ({ label, error, hint, size = 'md', options, className, id, ...props }, ref) => {
    ...
    return (
      <div className="flex flex-col gap-1.5">
        {label && (
          <label htmlFor={selectId} className="text-[13px] font-semibold text-neutral-700">
            {label}
          </label>
        )}
        <div className="relative">
          <select
            ...
            id={selectId}
            className={cn(
              'w-full appearance-none rounded-xl border border-neutral-200 bg-white text-neutral-900',
