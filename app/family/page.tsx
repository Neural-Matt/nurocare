    ...
    <div className="bg-white rounded-2xl border border-neutral-100 shadow-card p-5 flex items-start gap-4">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-2">
          <div>
            <p className="font-bold text-neutral-900 text-[15px] leading-tight">{member.name}</p>
            <div className="flex items-center gap-2 mt-1.5 flex-wrap">
              ...
              <span className={cn(
                ...
                member.plan_id ? 'bg-accent-50 text-accent-700' : 'bg-neutral-100 text-neutral-500',
              )}>
          ...
          <div className="flex items-center gap-1 shrink-0">
            <button
              ...
              className="w-8 h-8 rounded-xl hover:bg-neutral-100 flex items-center justify-center text-neutral-400 hover:text-primary-700 transition-colors"
              aria-label="Edit"
            >
    ...
    <AppShell title="My Family">
      ...
      {loading ? (
        <div className="space-y-3">
          {[0, 1, 2].map((i) => (
            <div key={i} className="bg-white rounded-2xl border border-neutral-100 shadow-card p-5 animate-pulse">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-2xl bg-neutral-100 shrink-0" />
        ...
        <Card padding="none" className="overflow-hidden">
          ...
          <div className="flex flex-col items-center py-14 text-center gap-4 px-6">
            <div className="w-20 h-20 rounded-2xl bg-neutral-100 border border-neutral-200 flex items-center justify-center">
              <Users className="w-9 h-9 text-neutral-300" />
            </div>
            <div>
              <p className="font-display font-bold text-neutral-700 text-lg mb-1">No family members yet</p>
            ...
            <Button variant="primary" onClick={openAdd} leadingIcon={<Plus className="w-4 h-4" />}>
              Add First Member
            </Button>
          </div>
        </Card>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            <Button variant="ghost" fullWidth onClick={() => setConfirmRemove(null)} className="border border-neutral-200">
              Cancel
            </Button>
